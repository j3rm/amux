...
- Test suite: `/Users/ethan/Dev/amux/tests/browser-comparison.js`
- Auth profile: `~/.amux/playwright-auth/profile`
- Results JSON: `/tmp/pw-test-results.json`
- Screenshots: `/tmp/pw-test-*.png`
- Requires: `npm install --prefix /Users/ethan/Dev/amux` (playwright is a local devDependency)

## Commands

### `run` or empty — Run the full test suite

Run all 22 Playwright UI tests:

```bash
node /Users/ethan/Dev/amux/tests/browser-comparison.js
```
...
Add a new test case to `/Users/ethan/Dev/amux/tests/browser-comparison.js`:
...
- Always use absolute paths (`/Users/ethan/Dev/amux/...`)
